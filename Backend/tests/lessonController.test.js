...
// Soefia/Backend/controller/lessonController.test.js
...
describe('Lesson Controller', () => {
    ...
    describe('createLesson', () => {
        ...
        it('should create a lesson successfully', async () => {
            ...
            Lesson.prototype.save = jest.fn().mockResolvedValue({ _id: 'lessonId' });
            Teacher.findOne.mockResolvedValue({ _id: 'teacherId', upcomingLesson: [], save: jest.fn() });
            Class.findOne.mockResolvedValue({ _id: 'classId', lessonsId: [], save: jest.fn() });
    ...
    describe('updateLesson', () => {
        ...
        it('should update a lesson successfully', async () => {
            ...
            Lesson.findOneAndUpdate.mockResolvedValue({ _id: 'lessonId' });
            Teacher.findOne.mockResolvedValue({ _id: 'teacherId', upcomingLesson: ['lessonId'], save: jest.fn() });
